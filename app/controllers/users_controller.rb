...
class UsersController < ApplicationController
  ...
  def accept_request
    ...
    return unless inv.update(confirmed: true)

    redirect_to friends_path,
                notice: "You have successfully #{User.find(params[:friend_id]).username} added as a friend!"
  end
  ...
  def reject_request
    ...
    redirect_to friends_path,
                alert: "You have successfully removed #{User.find(params[:friend_id]).username} as a friend!"
  end
